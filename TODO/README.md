# Checklist Senior Full-Stack — índice

Conceptos + ejemplos de negocio, uno por tema. Antes era un solo archivo
(`Services_TODO.md`), dividido aquí para navegar más fácil.

1. [APIs y comunicación](01-apis-comunicacion.md)
2. [Auth y seguridad](02-auth-seguridad.md)
3. [Datos](03-datos.md)
4. [Mensajería y eventos](04-mensajeria-eventos.md)
5. [Concurrencia y performance](05-concurrencia-performance.md)
6. [Pagos](06-pagos.md)
7. [Tiempo real](07-tiempo-real.md)
8. [Arquitectura y resiliencia](08-arquitectura-resiliencia.md)
9. [GraphQL](09-graphql.md)
10. [Testing](10-testing.md)
11. [Observabilidad](11-observabilidad.md)
12. [DevOps/Infra](12-devops-infra.md)
